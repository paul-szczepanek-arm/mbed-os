...
/**
 * Handle events generated by ble::pal::PalSecurityManager
 */
...
public:
     ...
     *
     * @note shall be followed by: pal::PalSecurityManager::passkey_request_reply
     * @param[in] connection connection handle
     ...
     *
     * @param[in] connection connection handle
     * @note shall be followed by: pal::PalSecurityManager::secure_connections_oob_request_reply
     * or a cancellation of the procedure.
     */
     ...
     *
     * @param[in] connection connection handle
     * @note shall be followed by: pal::PalSecurityManager::legacy_pairing_oob_request_reply
     * or a cancellation of the procedure.
     */
...
class PalSecurityManager : private mbed::NonCopyable<PalSecurityManager> {
