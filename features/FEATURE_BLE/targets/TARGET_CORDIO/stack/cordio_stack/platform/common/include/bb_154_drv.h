...
enum
{
  ...
  BB_154_DRV_FLAG_RAW            = (1 << 4)   /*!< Treat as raw frame */
};
...
typedef uint8_t (*Bb154DrvRxIsr_t)(uint8_t *pBuf, uint16_t len, int8_t rssi, uint32_t timestamp, uint8_t flags);

/*! \brief      CCA or energy detect complete ISR callback signature. */
typedef void (*Bb154DrvEdIsr_t)(int8_t rssi);
 ...
 */
/*************************************************************************************************/
uint8_t *Bb154DrvGetPayloadPtr(uint8_t *pFrame, uint16_t fctl);
 ...
 */
/*************************************************************************************************/
uint8_t Bb154DrvRssiToLqi(int8_t rssi);
 ...
 */
/*************************************************************************************************/
void Bb154DrvGetLastRssi(uint8_t *pBuf);
